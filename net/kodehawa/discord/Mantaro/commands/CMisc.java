...
public class CMisc implements Command {

	ArrayList<User> users = new ArrayList<>();
	
	@ModuleProperties(level = "user", name = "random", type = "common", description = "Miscelaneous commands.", additionalInfo = "Possible args: rob *menction*/lottery/reverse *string to reverse*"
			, takesArgs = true)
	@Override
	...
	public void botAction(String[] msg, String whole, String beheaded, MessageReceivedEvent evt) {
		...
		else if(beheaded.startsWith("reverse"))
		{
			String stringToReverse = beheaded.replace("reverse ", "");
			
			String reversed = new StringBuilder(stringToReverse).reverse().toString();
			
			evt.getChannel().sendMessageAsync(reversed, null);
		}
	}
}
