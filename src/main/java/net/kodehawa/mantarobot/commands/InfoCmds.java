...
public class InfoCmds implements HasPostLoad {
	...
	public static void about(CommandRegistry cr) {
		cr.register("about", SimpleCommand.builder(Category.INFO)
	...
	public static void avatar(CommandRegistry cr) {
		cr.register("avatar", SimpleCommand.builder(Category.INFO)
				.permission(CommandPermission.USER)
				.code((thiz, event, content, args) -> {
	...
	public static void help(CommandRegistry cr) {
		...
		cr.register("help", SimpleCommand.builder(Category.INFO)
				.permission(CommandPermission.USER)
				.code((thiz, event, content, args) -> {
					if (content.isEmpty()) {
	...
	public static void info(CommandRegistry cr) {
		cr.register("info", SimpleCommand.builder(Category.INFO)
				.permission(CommandPermission.USER)
				.code((thiz, event, content, args) -> {
					List<Guild> guilds = MantaroBot.getInstance().getGuilds();
	...
	public static void invite(CommandRegistry cr) {
		cr.register("invite", SimpleCommand.builder(Category.INFO)
				.permission(CommandPermission.USER)
				.code((thiz, event, content, args) -> {
	...
	public static void ping(CommandRegistry cr) {
		...
		cr.register("ping", SimpleCommand.builder(Category.INFO)
				.permission(CommandPermission.USER)
				.code((thiz, event, content, args) -> {
	...
	public static void shard(CommandRegistry cr) {
		cr.register("shardinfo", SimpleCommand.builder(Category.INFO)
				.permission(CommandPermission.USER)
				.code((thiz, event, content, args) -> {
	...
	public static void stats(CommandRegistry cr) {
		cr.register("stats", SimpleCommand.builder(Category.INFO)
				.permission(CommandPermission.USER)
				.code((thiz, event, content, args) -> {
					if (content.isEmpty()) {
	...
	public static void userinfo(CommandRegistry cr) {
		cr.register("userinfo", SimpleCommand.builder(Category.INFO)
				.permission(CommandPermission.USER)
				.code((thiz, event, content, args) -> {
