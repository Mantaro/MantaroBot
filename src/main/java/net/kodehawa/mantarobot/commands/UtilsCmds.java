...
public class UtilsCmds {
	...
	public static void birthday(CommandRegistry cr) {
		cr.register("birthday", SimpleCommand.builder(Category.UTILS)
	...
	public static void googleSearch(CommandRegistry cr) {
		cr.register("google", SimpleCommand.builder(Category.UTILS)
				.permission(CommandPermission.USER)
				.code((thiz, event, content, args) -> {
	...
	public static void time(CommandRegistry cr) {
		cr.register("time", SimpleCommand.builder(Category.UTILS)
				.permission(CommandPermission.USER)
				.code((thiz, event, content, args) -> {
					try {
	...
	public static void translate(CommandRegistry cr) {
		cr.register("translate", SimpleCommand.builder(Category.UTILS)
				.permission(CommandPermission.USER)
				.code((thiz, event, content, args) -> {
					try {
	...
	public static void urban(CommandRegistry cr) {
		cr.register("urban", SimpleCommand.builder(Category.UTILS)
				.permission(CommandPermission.USER)
				.code((thiz, event, content, args) -> {
	...
	public static void weather(CommandRegistry cr) {
		cr.register("weather", SimpleCommand.builder(Category.FUN)
				.permission(CommandPermission.USER)
				.code((thiz, event, content, args) -> {
					if (content.isEmpty()) {
						thiz.onHelp(event);
	...
	public static void ytmp3(CommandRegistry cr) {
		cr.register("ytmp3", SimpleCommand.builder(Category.FUN)
				.permission(CommandPermission.USER)
				.code((thiz, event, content, args) -> {
