        ...
        profileCommand.addSubCommand("stats", new SubCommand() {
            ...
            protected void call(GuildMessageReceivedEvent event, I18nContext ctx, String content) {
                ...
                String s = String.join("\n",
                        ...
                        prettyDisplay(ctx.get("commands.profile.stats.sharks_caught"), String.valueOf(playerData.getSharksCaught())),
                        prettyDisplay(ctx.get("commands.profile.stats.crates_open"), String.valueOf(playerData.getCratesOpened())),
                        prettyDisplay(ctx.get("commands.profile.stats.times_mop"), String.valueOf(playerData.getTimesMopped())),
