...
public class Items {
    ...
    public static final Item[] ALL = {
            HEADPHONES = new Item("\uD83C\uDFA7", "Headphones", "That's what happens when you listen to too much music. Should be worth " +
                    "something, tho.", 5, true, false, false),
            BAN_HAMMER = new Item("\uD83D\uDD28",
                    "Ban Hammer", "Left by an admin. +INF Dmg", 15, false, false),
            KICK_BOOT = new Item("\uD83D\uDC62",
                    "Kick Boot", "Left by an admin. +INF Knockback", 12, false, false),
            FLOPPY_DISK = new Item("\uD83D\uDCBE",
                    "Floppy Disk", "Might have some games.", 13, false, false),
            MY_MATHS = new Item("\uD83D\uDCDD",
                    "My Maths", "\"Oh, I forgot my maths.\"", 11, false, false),
            PING_RACKET = new Item("\uD83C\uDFD3",
                    "Ping Racket", "I won the game of ping-pong with Discord by a few milliseconds.", 15, false, false),
            LOADED_DICE = new Item("\uD83C\uDFB2",
                    "Loaded Die", "Stolen from `~>roll` command", 60, false, false),
            FORGOTTEN_MUSIC = new Item("\uD83C\uDFB5",
                    "Forgotten Music", "Never downloaded. Probably has been copyrighted.", 15, false, false),
            CC_PENCIL = new Item("\u270f",
                    "Pencil", "We have plenty of those!", 15, false, false),
