...
public class Items {
    ...
    public static final Item[] ALL = {
            ...
            OLD_SPARKLE_ROD = new FishRod(ItemType.DEPRECATED, 3, -1, -1, "\uD83C\uDFA3", "Old Sparkly Rod", "general.deprecated", "general.deprecated", 65, "", Collections.emptyList(), 2),
            ...
            MOON_PICK = new Pickaxe(ItemType.MINE_RARE_PICK, 0.1f, 3, 7, EmoteReference.MOON_PICK.getDiscordNotation(), "Moon Pickaxe", "items.moon_pick", "items.description.moon_pick", 1000, true, false, "1;3;2;5;10", List.of(74, 10, 101), 320, 10, 83, 18, 76, 101),
            HELLFIRE_PICK = new Pickaxe(ItemType.MINE_RARE_PICK_NODROP, 0.00001f, 3, 1, EmoteReference.HELLFIRE_PICK.getDiscordNotation(), "Hellfire Pickaxe", "items.hellfire_pick", "items.description.hellfire_pick", 15000, true, false, "450;1;175;1;175;1;55;1;50;50", Collections.emptyList(), 3000, 18, 57, 48, 61, 49, 62, 74, 73, 101, 76),
            AXE = new Axe(ItemType.CHOP_AXE, 0.19f, "\uD83E\uDE93", "Axe", "items.axe", "items.description.axe", 100, true, 35),
            COMET_AXE = new Axe(ItemType.CHOP_AXE, 0.13f, 1, 10, EmoteReference.COMET_AXE.getDiscordNotation(), "Comet Axe", "items.comet_axe", "items.description.comet_axe", 290, true, false, "1;3;8", List.of(48, 101), 170, 104, 48, 101),
            STAR_AXE = new Axe(ItemType.CHOP_AXE, 0.09f, 1, 10, EmoteReference.STAR_AXE.getDiscordNotation(), "Star Axe", "items.star_axe", "items.description.star_axe", 350, true, false, "1;3;7", List.of(49, 101), 220, 104, 49, 101),
            SPARKLE_AXE = new Axe(ItemType.CHOP_RARE_AXE, 0.04f, 3, 5, EmoteReference.SPARKLE_AXE.getDiscordNotation(), "Sparkle Axe", "items.sparkle_axe", "items.description.sparkle_axe", 1200, true, false, "1;3;2;8", List.of(74, 104, 101), 500, 104, 74, 18, 101),
            MOON_AXE = new Axe(ItemType.CHOP_RARE_AXE, 0.1f, 3, 7, EmoteReference.MOON_AXE.getDiscordNotation(), "Moon Axe", "items.moon_axe", "items.description.moon_axe", 1000, true, false, "1;3;2;10", List.of(83, 104, 101), 330, 104, 83, 18, 101),
            HELLFIRE_AXE = new Axe(ItemType.CHOP_RARE_AXE_NODROP, 0.00001f, 3, 1, EmoteReference.HELLFIRE_AXE.getDiscordNotation(), "Hellfire Axe", "items.hellfire_axe", "items.description.hellfire_axe", 15000, true, false, "450;175;1;175;1;55;1;50;50", Collections.emptyList(), 3100, 18, 48, 105, 49, 106, 74, 107, 101, 76),
            MOON_ROD = new FishRod(ItemType.CAST_FISH, 12, 3, 4, EmoteReference.MOON_ROD.getDiscordNotation(), "Moon Rod", "items.moon_rod", "items.description.moon_rod", 800, "1;3;3", List.of(44, 18), 120, 44, 83, 101),
            HELLFIRE_ROD = new FishRod(ItemType.FISHING_RARE_NODROP, 14, 3, 4, EmoteReference.HELLFIRE_ROD.getDiscordNotation(), "Hellfire Rod", "items.hellfire_rod", "items.description.hellfire_rod", 15000, "450;175;1;175;1;50;1;35;50", Collections.emptyList(), 2300, 18, 48, 105, 49, 106, 74, 107, 101, 76),
