...
public class Items {
    ...
    public static final Item[] ALL = {
            ...
            RING = new Item(EmoteReference.RING.getUnicode(), "Marriage Ring", "Basically what makes your marriage official", 60, true),
            LOVE_LETTER = new Item(EmoteReference.LOVE_LETTER.getUnicode(), "Love Letter", "A letter from your beloved one.", 55, false),
            LOOT_CRATE_KEY = new Item(EmoteReference.KEY.getUnicode(), "Crate Key", "Used to open loot boxes with `~>opencrate`", 58, true),
            CLOTHES = new Item(EmoteReference.CLOTHES.getUnicode(), "Clothes", "Basically what you wear.", 15, true),
            ...
            TUXEDO = new Item(EmoteReference.TUXEDO.getUnicode(), "Tuxedo", "What you wear when you're going to get married with a girl.", 24, true),
            SHOES = new Item(EmoteReference.SHOES.getUnicode(), "Shoes", "Cause walking barefoot is just nasty.", 9, true),
            ...
            BOOSTER = new Item(EmoteReference.RUNNER.getUnicode(), "Booster", "Used to give you some kind of boost, now its broken. `Leftover from Currency version 1. No longer obtainable.`"),
            ...
            LOOT_CRATE = new Item(EmoteReference.LOOT_CRATE.getDiscordNotation(), "Loot Crate", "You can use this along with a loot key to open a loot crate! `~>opencrate`", 0, false, false, true),
