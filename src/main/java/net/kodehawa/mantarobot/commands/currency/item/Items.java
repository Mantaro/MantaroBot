...
public class Items {
    ...
    public static final Item[] ALL = {
            ...
            HELLFIRE_PICK = new Pickaxe(ItemType.MINE_RARE_PICK, 0.00001f, 3, 1, EmoteReference.HELLFIRE_PICK.getDiscordNotation(), "Hellfire Pickaxe", "items.hellfire_pick", "items.description.hellfire_pick", 15000, true, false, "999;1;175;1;175;1;55;1;50;50", Collections.emptyList(), 3000, 18, 57, 48, 61, 49, 62, 74, 73, 101, 76),
            ...
            HELLFIRE_AXE = new Axe(ItemType.CHOP_RARE_AXE, 0.00001f, 3, 1, EmoteReference.HELLFIRE_AXE.getDiscordNotation(), "Hellfire Axe", "items.hellfire_axe", "items.description.hellfire_axe", 15000, true, false, "999;1;175;1;175;1;55;1;50;50", Collections.emptyList(), 3100, 18, 57, 48, 61, 49, 62, 74, 73, 101, 76),
            ...
            HELLFIRE_ROD = new FishRod(ItemType.CAST_FISH, 14, 3, 4, EmoteReference.HELLFIRE_ROD.getDiscordNotation(), "Hellfire Rod", "items.hellfire_rod", "items.description.hellfire_rod", 15000, "999;175;1;175;1;50;1;35;50", Collections.emptyList(), 2300, 18, 48, 105, 49, 106, 74, 107, 101, 76),
