...
public class Items {
    ...
    public static final Item[] ALL = {
            ...
            MOON_AXE = new Axe(ItemType.CHOP_RARE_AXE, 0.1f, 3, 7, EmoteReference.MOON_AXE.getDiscordNotation(), "Moon Pickaxe", "items.moon_pick", "items.description.moon_pick", 1000, true, false, "1;3;2;10", List.of(83, 10, 101), 480, 10, 83, 18, 101),
