...
public class Items {
	public static final Item HEADPHONES, BAN_HAMMER, KICK_BOOT, FLOPPY_DISK, MY_MATHS, PING_RACKET,
			...
			BOOSTER, BERSERK, ENHANCER, RING_2, COMPANION, LOADED_DICE_2, LOVE_LETTER, CLOTHES, SHOES, DIAMOND, CHOCOLATE, COOKIES, NECKLACE, ROSE,
			DRESS, TUXEDO;

	public static final Item[] ALL = {
		HEADPHONES = new Item("\uD83C\uDFA7", "Headphones", "That's what happens when you listen to too much music. Should be worth something, tho.", 50, true, false),
		...
		BROM_PICKAXE = new Item("\u26cf", "Brom's Pickaxe", "That guy liked Minecraft way too much. Gives you a stackable boost when doing ~>mine.", 500, true),
		...
		CLOTHES = new Item(EmoteReference.CLOTHES.getUnicode(), "Clothes", "Basically what you wear, but 100x more expensive.", 1000, true),
		DIAMOND = new Item(EmoteReference.DIAMOND.getUnicode(), "Diamond", "Basically a better way of saving your money. It's shiny too.", 150000, true),
		...
		TUXEDO = new Item(EmoteReference.TUXEDO.getUnicode(), "Tuxedo", "What you use when you're going to get married with a girl.", 25000, true),
		SHOES = new Item(EmoteReference.SHOES.getUnicode(), "Shoes", "Something you use when you don't want to walk on dirt.", 1200, true),
		...
		LOADED_DICE_2 = new Item("\uD83C\uDFB2", "Loaded Dice", "Stolen from `~>dice` command. Gives you a 50% more chance at getting a perfect score on dice."),
