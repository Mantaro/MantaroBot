...
public class FinderUtils {
    ...
    private static List<TextChannel> findChannel0(MessageReceivedEvent event, String content) {
    ...
    public static TextChannel findChannel(MessageReceivedEvent event, String content) {
    ...
    public static TextChannel findChannelSelect(MessageReceivedEvent event,
